        ...
        onPressed: ()async{
          try{
              ...
              if(_image!=null){
                ...
                _proceessedImage = await ArtisticStyleTransfer.styleTransfer(styles: _selectedStyles, inputFilePath: _image.path, outputFilePath: tempPath, quality: 100, styleFactor: 1.0, convertToGrey: false);
                setState(() {
                  _isSaving = false;
                });
              } else {
