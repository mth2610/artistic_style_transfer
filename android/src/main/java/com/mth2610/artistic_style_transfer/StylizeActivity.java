...
//    private final float[] styleVals = new float[NUM_STYLES];
    ...
    public String styleTransfer(Context context, final Integer[] styles, String inputFilePath, final String outputDir) {
//        int desiredSize = 256;
        //tensorFlowInferenceInterface = new TensorFlowInferenceInterface(context.getAssets(),MODEL_FILE);
        Bitmap inputBitmap = BitmapFactory.decodeFile(inputFilePath);
        int previewWidth = inputBitmap.getWidth();
        int previewHeight = inputBitmap.getHeight() + 1;
//        int desiredWidth = previewWidth;
//        int desiredHeight = previewWidth;
        int desiredWidth = 720;
        int desiredHeight = 720;
        Log.i("inputWidth",String.valueOf(inputBitmap.getWidth()));
        Log.i("inputWidth",String.valueOf(inputBitmap.getHeight()));
